...
import de.kochapp.adapter.GUIFunktionen.FunktionenRezeptBearbeiten;
import de.kochapp.domain.Kategorie.Kategorie;
import de.kochapp.domain.Kategorie.KategorieRepository;
import de.kochapp.domain.Rezept.Einheit;
...
public class RezeptBearbeiten {
    ...
    public RezeptBearbeiten(Rezept rezept, DataReader dataReader)  {
        ...
        for(Zutat zutat : zutaten){
            model.addRow(new Object[]{String.valueOf(zutat.bekommeMenge().dieMenge()),zutat.bekommeMenge().dieEinheit().bekommeBezeichnung(), String.valueOf(zutat.bekommeBezeichnung()), "-"});
        }
